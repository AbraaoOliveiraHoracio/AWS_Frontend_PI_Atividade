...
export class ProfessoresService {
  private apiUrl = 'https://api.projetointregadoratividade.duckdns.org/teacher/';  // Nova URL da API
  private cursosUrl = 'https://api.projetointregadoratividade.duckdns.org/courses'; // Caso precise acessar cursos também
